...
export default function NttmCreateTableName({renderNttmTableName, onNttmAdd, onNttmEdit}) {
      ...
      <form>
        ...
        <div className="input-group mb-3">
            ...
            >
                ...
                <option value={false} className=''>Non-Active</option>
            </select>
        </div>
